...
STATS = [('97', 'registros trazables'), ('51', 'fuentes consultadas'), ('13', 'municipios monitoreados')]
...
centrado(d, 'Una sola página con fuentes y fechas', fuente('sans', 40), 500, SUAVE, 1080)
...
centrado(d, 'No intermediamos: distinguimos fuentes oficiales y secundarias.', fuente('sans', 28), fin + 510, SUAVE, 1080)
...
centrado(d, 'Todo con evidencia y fecha de revisión.', fuente('sans', 28), fin + 344, SUAVE, 1080)
...
centrado(d, 'Una sola página, trazable,', fuente('sans', 46), 1090, SUAVE, 1080)
...
centrado(d, 'con evidencia.', fuente('serif-b', 84), 610, AZUL, 1080)
fila_stats(d, 1080, 850, 1.1)
centrado(d, 'Cada dato con su fuente y su fecha.', fuente('sans', 42), 1180, SUAVE, 1080)
guardar(img, d, 2)

for n, (cap, l1, l2) in [(3, (CAP_HERO, 'Canales de donación,', 'con evidencia y fecha.')),
